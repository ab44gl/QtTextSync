...
QtTextSync::QtTextSync(QWidget *parent) : QMainWindow(parent)
{
   ...
   // event
   {
      ...
      // refresh buttton
      QObject::connect(ui.but_refresh, &QPushButton::clicked, [this]() { pullTextAndUpdate(); });
      // post button
      QObject::connect(ui.but_post, &QPushButton::clicked, [this]() {
         QNetworkRequest request2;
         request2.setUrl(QUrl(QString("http://") + "localhost" + QString(":8080/")));
   ...
   QObject::connect(timer, &QTimer::timeout, [this]() { pullTextAndUpdate(); });
}
